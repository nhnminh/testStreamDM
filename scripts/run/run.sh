...
./spark.sh "EvaluatePrequential -l (trees.HoeffdingTree -l 0 -t 0.05 -g 2 ) -s (FileReader -f ../data/randomtreedata.arff -k 10)" 1> result/hdt_100_NBA_small_nominal.res 2> result/majcl4_t.log
end=`date +%s`
