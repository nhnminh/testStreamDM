...
### rdtComplex 600k
./spark.sh "EvaluatePrequential  -l (trees.HoeffdingTree -l 0 -t 0.05 -g 200 ) -s (FileReader -f ../data/rdt300k.arff -k 10000 -i 700000 -d 100)" 1> result/hdt_1000_MC_complex300_p_splitNTimes.res 2> result/majcl4_t.log
